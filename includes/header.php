...
<body>
    <nav class="navbar bg-white justify-content-center justify-content-md-between border">
        <a class="navbar-brand text-warning text-center fa-1-5x" href="index.html">
            <img src="img/download.webp" class="w-25" alt="">Transea
        </a>

        <ul class="navbar nav justify-content-center">
            <li class="nav-item mr-3">
                <a class="text-dark fa-xs " href=""><i class="fa fa-mobile-alt"></i> +17207359347</a>
            </li>
    ...
    <nav class="navbar navbar-expand-md bg-warning p-0 pl-2 sticky-top">
        <div class="container">
            ...
            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#collapsibleNavbar">
                <img src="img/bar.png" class="w-50" alt="">
            </button>
